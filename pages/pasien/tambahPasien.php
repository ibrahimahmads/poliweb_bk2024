<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (mysqli_num_rows($queryCekKTP)>0) {
            echo '<script>alert("No KTP telah terdaftar sebelumnya");window.location.href="../../pasienAdmin.php";</script>';
        }
        // jika tidak tambahkan data baru
            ...
            if (mysqli_num_rows($query) < 1) {
                ...
                if ($queryInsert) {
                    echo '<script>alert("Pendaftaran akun berhasil");window.location.href="../../pasienAdmin.php";</script>';
                }
                else {
                    echo '<script>alert("Pendaftaran akun gagal");window.location.href="../../pasienAdmin.php";</script>';
                }
            }
