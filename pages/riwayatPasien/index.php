                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT daftar_poli.status_periksa, periksa.id, pasien.alamat, pasien.id as idPasien, pasien.no_ktp, 
                                pasien.no_hp, pasien.no_rm, periksa.tgl_periksa, pasien.nama as namaPasien, dokter.nama, 
                                daftar_poli.keluhan, periksa.catatan, GROUP_CONCAT(obat.nama_obat) as namaObat, SUM(obat.harga) AS hargaObat FROM detail_periksa 
                                INNER JOIN periksa ON detail_periksa.id_periksa = periksa.id INNER JOIN daftar_poli ON periksa.id_daftar_poli = daftar_poli.id 
                                INNER JOIN pasien ON daftar_poli.id_pasien = pasien.id INNER JOIN obat ON detail_periksa.id_obat = obat.id INNER JOIN jadwal_periksa 
                                ON daftar_poli.id_jadwal = jadwal_periksa.id INNER JOIN dokter ON jadwal_periksa.id_dokter = dokter.id WHERE status_periksa = '1' GROUP BY pasien.id";
                                                            ...
                                                            <table class="table table-hover text-nowrap">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                        ...
                                                                        $nomor = 1;
                                                                        require 'config/koneksi.php';
                                                                        $ambilData = "SELECT detail_periksa.id as idDetailPeriksa, periksa.tgl_periksa, pasien.nama as namaPasien, 
                                                                                    dokter.nama as namaDokter, poli.nama_poli , daftar_poli.keluhan, periksa.catatan,
                                                                                    GROUP_CONCAT(obat.nama_obat) as namaObat, periksa.biaya_periksa AS hargaObat 
                                                                                    FROM detail_periksa 
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $datas['namaDokter'] ?></td>
                                                                        <td><?php echo $datas['nama_poli'] ?></td>
