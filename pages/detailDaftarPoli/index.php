<?php
    ...
    $ambilDetail = mysqli_query($mysqli, "SELECT 
            ...
            GROUP_CONCAT(o.qty) as qtyObat,
            GROUP_CONCAT(o.kemasan) as kemasanObat
            FROM daftar_poli
        ...
        <div class="col-12 d-flex align-items-stretch flex-column">
                <div class="card bg-light d-flex flex-fill">
                    ...
                    <div class="card-body pt-0">
                        <div class="row">
                            <div class="col-7">
                                ...
                                <br><br>
                                <p class="text-muted text-lg"><strong>Tanggal Periksa:</strong> <?php echo $data['tgl_periksa'] ?></p>
                                <p class="text-muted text-lg"><strong>Catatan:</strong> <?php echo $data['catatan'] ?></p>
                                <br>
                                <p class="text-muted text-lg"> Obat : <br>
                                    <?php 
                                    $namaObatArray = explode(',', $data['namaObat']);
                                    $qtyArray = explode(',', $data['qtyObat']);
                                    $kemasanArray = explode(',', $data['kemasanObat']);

                                    foreach ($namaObatArray as $index => $namaObat) {
                                        echo ($index + 1) . ". " . $namaObat . " - " . $qtyArray[$index] . " " . $kemasanArray[$index] . "<br>";
                                    }
                                    ?>
                                </p>
                    ...
                    <div class="card-footer">
                        <div class="text-left">
                            <a href="daftarPoli.php" class="btn btn-md">
                                Kembali
                            </a>
                        </div>
                    </div>
